...
cd ${path_data}/bfs/inputGen/

cat << EOF > graphgen.cpp
/* modify
 * graphgen.cpp
...
for i in {16..25}
do 
	./graphgen $((1048576*i)) ${i}M
done

cd - 

cd ${path_data}/kmeans/inpuGen/
make
...
cd ${path_openmp}/myocyte/
make

cd -
cp ${path_openmp}/myocyte/myocyte.out .
