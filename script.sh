...
#done
#
#mv output_gramscmidt.csv ../../../../output
#cd -
#
...
mv output_correlation.csv ../../../output
cd -
...
mv output_covariance.csv ../../../output
cd -
##-------------------------------------------STENCILS--------------------------------------------------------------------
...
#	echo $output
#done
#mv output_convolution-2d.csv ../../../output
#cd -
...
###
###done
###mv output_convolution-3d.csv ../../../../output
###cd -
...
#	echo $output
#done
#mv output_fdtd-apml.csv ../../../output
#cd -
